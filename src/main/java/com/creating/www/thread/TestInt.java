...
public class TestInt {
	...
	public TestInt() {
		 ...
		 * before=new Before() {
		 * 
		 * @Override public void execute() { // TODO Auto-generated method stub
	...
	public static void start() {
		 ...
		 * 
		 * @Override public void execute() { // TODO Auto-generated method stub
		 * threadPool.startAllThread(); } }; proxy.addBefore(before);
		 * proxy.addTarget(target); proxy.addAfter(after); try { proxy.start(); } catch
